function Intro() {
  const specs = [
    ...
    { value: "29", label: "Capacidade de Bateria", color: "text-orange-500" },
  ];
  return (
    <section className="bg-black py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h1 className="text-6-xl md:text-8xl font-bold mb-6">iPhone 17 Pro</h1>
        <p className="text-2xl md:text-4xl textgradient">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
        ...
        <button className="border-2 border-white rounded-full hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-white/50 cursor-pointer">
          Saiba mais
        </button>
      </div>
