          ...
          <div className="grid grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-900 rounded-3xl p-8">
              ...
              <p className="text-gray-400">
                Estrutura em titânio de grau aeroespacial. O smartphone mais
                forte e leve.
              </p>
            </div>
            ...
            <div className="bg-gray-900 rounded-3xl p-8">
              <img
                className="w-full rounded-2xl mb-4"
                src={import.meta.env.BASE_URL + "img/ios-2025.jpg"}
                alt="ios-2025"
              />
              <h3 className="font-bold mb-2 text-3xl">IOS 26</h3>
              <p className="text-gray-400">
                O sitema operacinal mais avançado do mundo com IA integrada.
              </p>
            </div>
          </div>

          <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
            <h3 className="text-4xl font-bold mb-6 textgradient">A 18 Pro</h3>
            <p className="text-gray-300 mb-6">
              O chip mais poderoso em um smartphone
            </p>
            <img
              className="w-full rounded-2xl mb-4"
              src={import.meta.env.BASE_URL + "img/chip-a18.jpg"}
              alt="chip-a18"
            />
          ...
          <div id="camera" className="text-center">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className=" bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                ...
                <p className="text-gray-400">
                  Sensro quad-pixel com foco automático
                </p>
              </div>
              <div className=" bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
